...
var title =  "Like Water for Chocolate";
var pages = 256;
...
var sequel = `${title}: Alternate Ending`;
...
var books = ["Truly Devious", "Queen's Thief", "Red Queen", "Throne of Glass", "The Seven Realms"];
